...
namespace TB_QuestGame
{
    ...
    public static class Text
    {
        ...
        public static string MissionIntro()
        {
            ...
            "You are a simple peasant caught in the middle of a war that " +
            ...
            " \n" +
            "\tPress any key to begin the information gathering process.\n";
        ...
        public static string ListAllNpcObjects(IEnumerable<Npc> npcObjects)
        {
            ...
            foreach (Npc npcObject in npcObjects)
            {
                npcObjectRows +=
                    ...
                    $"{npcObject.MapLocationID}".PadRight(10) +
                    Environment.NewLine;
            }
