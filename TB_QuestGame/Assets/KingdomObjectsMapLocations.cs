    ...
    public static partial class KingdomObjects
    {
        public static List<MapLocation> MapLocations = new List<MapLocation>
        {
            ...
            new MapLocation
            {
                ...
                Accessable = true,
                RaceRequirement = Character.RaceType.Xoran,
                ItemRequirment = 5,
                ExperiencePoints = 20
            },
            ...
            new MapLocation
            {
                ...
                Accessable = true,
                RaceRequirement = Character.RaceType.Dwarven,
                ItemRequirment = 8,
                ExperiencePoints = 20
            },
            ...
            new MapLocation
            {
                ...
                Accessable = true,
                RaceRequirement = Character.RaceType.Elven,
                ItemRequirment = 7,
                ExperiencePoints = 20
            },
            ...
            new MapLocation
            {
                ...
                Accessable = true,
                RaceRequirement = Character.RaceType.Human,
                ItemRequirment = 6,
                ExperiencePoints = 20
            },
            ...
            new MapLocation
            {
                ...
                MapLocationID = 6,
                KingdomLocation = "Hylian Ocean",
                Description = "Located underwater near the Xoran Palace, this temple used to be a place " +
                              "of worship for the Xorans. Recent monster activity has made it too dangerous for prayer. ",
                GeneralContents = "The architecture is very similar to Xoran Domain. Representations of their gods are scattered  " +
                            "around in the form of statues and etchings. The halls are abandoned save monster tracks and " +
                            "the remains of brave souls who ventured here despite the danger.",
                Accessable = true,
                RaceRequirement = Character.RaceType.Xoran,
                ItemRequirment = 5,
                ExperiencePoints = 30
            ...
            new MapLocation
            {
                ...
                MapLocationID = 7,
                KingdomLocation = "Lonely Mountain",
                Description = "The City of Dale sits at the base of the Lonely Mountain. Long ago it was a Wealthy settlement " +
                              "but the fire-drake Smaug has layed waste to the area leaving little more than charred ruins in his wake. ",
                GeneralContents = "There is little left of the structures that once stood here. The skeleton of a thinner, dwarf sized individual  " +
                            "lays clutching a golden ring with strange markings engraved into it. Before you, a giant fire breathing serpent sleeps, " +
                            "guarding the Heart of the Mountain.",
                Accessable = true,
                RaceRequirement = Character.RaceType.Dwarven,
                ItemRequirment = 8,
                ExperiencePoints = 30
            ...
            new MapLocation
            {
                ...
                Description = "The only way to get here is through a portal located in Dol Blathanna. An unfamiliar sensation envelopes " +
                              "the body. The feeling seems to originate from the presence of strong magic from all around.",
                GeneralContents = "The architecture is exquisite with many arch-ways and building of stone and marble. The Elves that live here " +
                            "stand taller and appear more pale than their well known counterparts in Dol Blathanna. They wear thick armor   " +
                            "of some unknown dark metal and brandish large swords.",
                Accessable = true,
                RaceRequirement = Character.RaceType.Elven,
                ItemRequirment = 7,
                ExperiencePoints = 30
