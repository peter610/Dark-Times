...
namespace TB_QuestGame
{
    ...
    public class ConsoleView
    {
        ...
        public void DisplayLookAround()
        {
            ...
            //
            //get list of NPC's in current map location
            //
            List<Npc> npcsInCurrentMapLocation = _gameKingdom.GetNpcsByMapLocationId(_gamePlayer.MapLocationID);

            string messageBoxText = Text.LookAround(currentMapLocation) + Environment.NewLine + Environment.NewLine;
            messageBoxText += Text.GameObjectsChooseList(gameObjectsInCurrentMapLocation) + Environment.NewLine;
            messageBoxText += Text.NpcsChooseList(npcsInCurrentMapLocation);
        ...
        public int DisplayGetGameObjectToLookAt()
        {
            ...
            {
                DisplayGamePlayScreen("Look at an Object", Text.GameObjectsChooseList(gameObjectsInMapLocation), ActionMenu.ObjectMenu, "");
            ...
            {
                DisplayGamePlayScreen("Look at an Object", "It appears there are no game objects here.", ActionMenu.ObjectMenu, "");
            }
        ...
        public void DisplayLocationsVisited()
        {
            ...
            DisplayGamePlayScreen("Locations Visited", Text.VisitedLocations(visitedMapLocations), ActionMenu.PlayerMenu, "");
        }
        ...
        {
            DisplayGamePlayScreen("Player Information", Text.TravelerInfo(_gamePlayer), ActionMenu.PlayerMenu, "");
        }
        ...
        {
            DisplayGamePlayScreen("List: Npc Objects", Text.ListAllNpcObjects(_gameKingdom.Npcs), ActionMenu.AdminMenu, "");
        }
